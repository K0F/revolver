...
ffmpeg -f lavfi -i color=c=black:size=1920x1080:rate=25 -width 1920 -loop 1 -i tmp.svg -filter_complex "[0:v][1:v]overlay,fade=in:75:5,fade=out:175:5" -t 8 -c:v prores_ks -profile:v 3 -pix_fmt yuv422p10le -movflags +faststart -y "$1".mkv
